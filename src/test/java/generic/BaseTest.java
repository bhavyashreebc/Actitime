...
public class BaseTest {
	...
	//runs only once at the beginning of the F/W
	@BeforeSuite
	...
	//runs only once at the end of the F/W
	@AfterSuite
	...
	public void closeApp(ITestResult result) throws Exception
	{
		...
		if(status==2)
		{
			...
			String msg=result.getThrowable().getMessage();//prints the failure message in report
